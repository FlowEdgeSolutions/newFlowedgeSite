# ðŸ“§ EmailJS mit Microsoft Outlook einrichten
...
1. ðŸŒ Ã–ffnen Sie: [https://www.emailjs.com/](https://www.emailjs.com/)
2. ðŸ” Klicken Sie auf **"Sign Up"**
...
6. ðŸ“ **Notieren Sie sich die `Service ID`** (wird angezeigt)
...
<div style="font-family: 'Poppins', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
  ...
  <div style="padding: 40px 30px;">
    <h2 style="font-family: 'Space Grotesk', sans-serif; font-size: 24px; font-weight: 700; color: #10388c; margin: 0 0 24px 0;">ðŸŽ¯ Neue Kontaktanfrage</h2>
    ...
    <div style="background: #ffffff; border: 2px solid rgba(96, 149, 198, 0.2); border-radius: 12px; padding: 24px; margin-top: 24px;">
      <span style="font-size: 14px; font-weight: 600; color: #10388c; margin-bottom: 12px; display: block;">ðŸ’¬ Nachricht:</span>
...
ðŸ“ [`email-template.html`](./email-template.html)
...
5. ðŸ“ **Notieren Sie die `Template ID`** (wird angezeigt)
...
3. ðŸ“ **Kopieren Sie Ihren `Public Key`**
...
5. ðŸ“§ PrÃ¼fen Sie Ihr Outlook-Postfach

#### **Nach Deployment testen:**

Nach dem Vercel-Deployment:
- Besuchen Sie Ihre Live-Website: `https://ihre-domain.vercel.app/kontakt`
- Senden Sie eine Test-Nachricht
- PrÃ¼fen Sie Outlook (auch Spam-Ordner!)

---

## ðŸŽ¯ Ihre Konfiguration auf einen Blick
...
### âŒ Problem: "Authentication failed"
...
### âŒ Problem: E-Mails kommen nicht an
...
### âŒ Problem: "Template not found"
...
## ðŸ“Š Kostenlose Limits (EmailJS Free)
...
### EmailJS Support:
- ðŸ“– Dokumentation: [https://www.emailjs.com/docs/](https://www.emailjs.com/docs/)
- ðŸ’¬ Support: [https://www.emailjs.com/contact/](https://www.emailjs.com/contact/)

### Microsoft Outlook:
- ðŸ”§ Microsoft Support: [https://support.microsoft.com/outlook](https://support.microsoft.com/outlook)
...
**ðŸŽ‰ Fertig! Ihr Kontaktformular ist jetzt voll funktionsfÃ¤hig!**
